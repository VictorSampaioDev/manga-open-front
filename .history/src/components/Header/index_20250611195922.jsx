...
const Header = () => {
    ...
    return (
         ...
         <header className="flex px-12 py-5 items-center justify-between glassmorphism-border bg-black opacity-90">
            <div className='flex gap-12 items-center'>
                ...
                <div className="flex gap-8 text-2xl">
                    <NavLink className="[&.active]:font-bold [&.active]:text-(--button-color) hover:drop-shadow-[0_0_20px_var(--button-color)] duration-150 text-(--text-color) text-2xl" to="/">
                        Home
                    </NavLink>
