  ...
  return (
    <>
      <div className="animated-gradient h-screen flex items-center justify-center p-4 sm:p-6 md:p-8">
        <div className="flex flex-col items-center glassmorphism-border rounded-4xl bg-black bg-opacity-60 max-w-lg md:max-w-xl w-full mx-auto p-8 md:p-12 lg:p-16">
