const CreateUser = () => {
    return ( 
        <>
        <div className="animated-gradient h-screen flex flex-wrap justify-center">
            <div className="flex flex-col items-center glassmorphism-border rounded-4xl bg-black opacity-40 ml-[300px] mr-[300px] mt-[100px] mb-[90px] p-[120px] ">
                <h1 className="text-white font-bold relative -top-[30px]">Crie sua conta</h1>
                <form>
                    <label>
                    <div>
