...
const LoginRegister = () => {
    return ( 
        ...
        <div className="animated-gradient h-screen flex justify-center">
            <div className="flex flex-col items-center glassmorphism-border rounded-4xl bg-black opacity-70 ml-[300px] mr-[300px] mt-[80px] mb-[100px] p-[120px] ">
                ...
                <form>
                    ...
                    <label>
                        ...
                        <div className="flex justify-center mt-[90px]">
                            <NavLink to="/create-account" className="text-white">
