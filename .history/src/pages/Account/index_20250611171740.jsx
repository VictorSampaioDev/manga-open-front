const LoginRegister = () => {
    return ( 
        <>
        <div className="animated-gradient h-screen justify-center">
            <div className="flex flex-col items-center border rounded-full bg-black opacity-70 ml-100 mr-100 mt-50 p-35 ">
